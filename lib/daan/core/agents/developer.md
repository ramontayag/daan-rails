...
3. Read `AGENTS.md`, `README.md`, and other project documentation in the repo root — they contain repo-specific instructions (test commands, conventions, architecture notes, PR guidelines). Follow them throughout your work.
...
9. Follow the repo's instructions (`AGENTS.md`, `README.md`, etc.) for what to do next — open a PR, deploy, or whatever the repo specifies.
